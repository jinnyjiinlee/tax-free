      ...
      <header className="relative z-20 glass-premium border-b border-slate-200/40">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/"
              className="flex items-center gap-1.5 min-h-[44px] px-3 py-2 rounded-xl text-slate-500 hover:text-slate-800 hover:bg-slate-100/80 transition-all text-sm font-medium"
              aria-label="홈으로 돌아가기"
            >
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/diagnosis"
              className="flex items-center gap-1.5 min-h-[44px] px-3.5 py-2 rounded-xl text-slate-500 hover:text-slate-800 hover:bg-slate-100/80 transition-all text-sm font-medium border border-slate-200 hover:border-slate-300"
